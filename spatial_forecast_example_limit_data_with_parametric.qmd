...
fc_mean <- rast('parametric/lognormal_mu_forecast.tif')
plot(fc_mean, main = 'Forecast Mean')

fc_sd <- rast('parametric/lognormal_sigma_forecast.tif')
plot(fc_sd, main = 'Forecast SD')
