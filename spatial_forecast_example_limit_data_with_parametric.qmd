...
scored_forecast_dir <- scoring_spat_parametric(fc_dir = parametric_forecast_dir,
                                             target = target,
                                             scores_dir = 'scores')


scores_crps <- rast('scores/crps_scores_parametric.tif')
plot(scores_crps, main = 'CRPS Scores')

scores_logs <- rast('scores/logs_scores_parametric.tif')
plot(scores_logs, main = 'Logarithmic Scores')
...
mc_mirror("scores/", "efi/spat4cast-scores/variable=lai_recovery/site_id=august_complex/")
