...
To facilitate spatio-temporal forecasting at the sites of interest for this challenge, time series data of 500m LAI measurements are stored in a MinIO bucket. MinIO is high-performance
software-defined S3 compatible object storage. To read and write to the forecast cloud, we use functions with the prefix "spat4cast\_". We can use `spat4cast_get_data()` to read in a
...
One source of information about the fire are burn severity metrics, The
