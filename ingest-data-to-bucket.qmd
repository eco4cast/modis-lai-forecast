...
mc_cp("cube", paste0("efi/spat4cast-data/variable=lai_recovery/site_id=", fire,"/"),
      recursive = TRUE)
...
dates <-str_extract(dir_ls("files/"), "(?<=/).*(?=\\.)")

cube <- gdalcubes::create_image_collection(dir_ls("files/"), date_time = dates)
