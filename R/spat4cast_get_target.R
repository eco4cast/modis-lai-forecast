...
#' @export
#' 
spat4cast_get_target <- function(date = "2025-04-01", fire = "august_complex"){
  ...
  mc_cp(paste0("efi/spat4cast-targets/duration=P1M/variable=lai_recovery/site_id=",fire,"/lai_recovery-target-", date,".tif"), "target")
